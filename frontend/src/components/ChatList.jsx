...
const ChatList = () => {
  ...
  return (
    <div className="flex-1 flex flex-col h-full">
      ...
      <div className="p-4 border-b border-slate-700/50 relative bg-slate-800/20">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-cyan-500 to-cyan-600 flex items-center justify-center shadow-lg shadow-cyan-500/30">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white rounded-lg hover:from-cyan-600 hover:to-cyan-700 transition text-xs font-medium shadow-lg shadow-cyan-500/30"
          >
